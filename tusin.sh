...
grep "tusin"$1 bn.list > search
  ...
  # 0バイトだったら追加
		(echo '- <a href="tusin'$1'.html">'$YEAR'年'$MONTH1'月号 <img src="media/Speaker_Icon_gray.png" srcset="media/Speaker_Icon_gray.svg" alt="音声付き" class="gyo" /></a><br />' && cat bn.list) > bn.list1 && mv bn.list1 bn.list
		echo '---' > temp.md
